...
class Company(db.Model):
    ...
    logo_file_path = db.Column(db.String(500), nullable=True)
    logo_original_name = db.Column(db.String(255), nullable=True)
    brand_primary_color = db.Column(db.String(7), nullable=True)
