...
SALES_READINESS_SECTIONS = (
    ...
    {
        "title": "Rakip Analizi - ISO 9001 / QDMS Modülleri",
        "items": (
            ("competitor_change_management", "Değişiklik yönetimi modülü"),
            ("competitor_deviation_management", "Sapma ve uygunsuz ürün yönetimi"),
            ("competitor_incident_near_miss", "Olay ve ramak kala bildirim modülü"),
            ("competitor_fmea", "FMEA risk yönetimi"),
            ("competitor_process_bpm", "Süreç yönetimi / BPM haritası"),
            ("competitor_quality_objectives", "Kalite hedefleri, KPI ve BSC takibi"),
            ("competitor_dynamic_checklist", "Dinamik checklist ve form tasarımı"),
            ("competitor_inspection_management", "Saha kontrol / muayene yönetimi"),
            ("competitor_stakeholder_management", "İlgili taraflar ve beklenti yönetimi"),
            ("competitor_compliance_obligations", "Yasal şartlar ve mevzuat takip modülü"),
            ("competitor_customer_request_portal", "Müşteri talep ve geri bildirim portalı"),
            ("competitor_advanced_supplier_quality", "Tedarikçi kalite denetimi ve anketleri"),
            ("competitor_ebys", "EBYS / resmi yazışma ve arşiv opsiyonu"),
            ("competitor_equipment_lifecycle", "Cihaz / ekipman yaşam döngüsü yönetimi"),
        ),
    },
    {
        "title": "Rakip Analizi - Sürekli İyileştirme ve QHSE Opsiyonları",
        "items": (
            ("competitor_kaizen_projects", "Kaizen / sürekli iyileştirme proje modülü"),
            ("competitor_five_s_audit", "5S saha denetimi modülü"),
            ("competitor_a3_problem_solving", "A3 / 8D problem çözme modülü"),
            ("competitor_lessons_learned", "Alınan dersler bilgi bankası"),
            ("competitor_help_desk", "İç talep / help desk modülü"),
            ("competitor_work_permits", "İş izinleri modülü"),
            ("competitor_hazardous_substances", "Tehlikeli madde yönetimi"),
            ("competitor_environmental_aspects", "Çevresel boyut ve atık takibi"),
            ("competitor_energy_management", "Enerji yönetimi ve tasarruf takibi"),
            ("competitor_ohs_risk_matrix", "İSG risk matrisi ve aksiyon bağlantısı"),
        ),
    },
    {
        "title": "Rakip Analizi - Platform Yetenekleri",
        "items": (
            ("competitor_workflow_designer", "Sürükle-bırak iş akışı tasarımcısı"),
            ("competitor_form_designer", "Parametrik form ve alan tasarımcısı"),
            ("competitor_report_designer", "Dashboard / rapor tasarımcısı"),
            ("competitor_mobile_pwa", "Mobil uyumlu PWA / QR ile hızlı bildirim"),
            ("competitor_multilanguage", "Çok dil altyapısı"),
    ...
    {
        "title": "Yeni Modül Havuzu - Strateji, Toplantı ve Planlama",
        "items": (
            ("module_meeting_notes", "Toplantı notları ve karar takip modülü"),
            ("module_meeting_action_decisions", "Toplantı kararlarından otomatik aksiyon oluşturma"),
            ("module_project_planning", "Proje yönetimi / planlama modülü"),
            ("module_project_gantt", "Gantt, kilometre taşı ve kaynak planlama"),
            ("module_swot_analysis", "SWOT analizi modülü"),
            ("module_pestle_analysis", "PESTLE / dış bağlam analizi"),
            ("module_context_stakeholders", "Kuruluş bağlamı ve ilgili taraflar matrisi"),
            ("module_risk_opportunity_portfolio", "Riskler ve fırsatlar portföyü"),
            ("module_quality_objective_projects", "Kalite hedeflerinden proje ve aksiyon planı oluşturma"),
            ("module_management_calendar", "Yıllık yönetim programı ve toplantı takvimi"),
            ("module_communication_plan", "İç / dış iletişim planı"),
            ("module_business_continuity", "İş sürekliliği ve acil durum aksiyon planı"),
        ),
    },
    {
        "title": "Yeni Modül Havuzu - Fabrika Operasyon ve Üretim",
        "items": (
            ("module_production_planning", "Üretim planlama modülü"),
            ("module_work_orders", "İş emri ve operasyon takip modülü"),
            ("module_shift_handover", "Vardiya devir teslim notları"),
            ("module_daily_production_report", "Günlük üretim raporu"),
            ("module_oee_downtime", "OEE, duruş ve kayıp zaman takibi"),
            ("module_capacity_planning", "Kapasite ve yük planlama"),
            ("module_material_lot_traceability", "Malzeme / parti / lot izlenebilirliği"),
            ("module_process_parameter_tracking", "Proses parametreleri ve kritik kontrol noktaları"),
            ("module_scrap_rework_tracking", "Fire, hurda ve yeniden işleme takibi"),
            ("module_nonconforming_product_quarantine", "Uygunsuz ürün karantina ve serbest bırakma"),
            ("module_incoming_quality_control", "Giriş kalite kontrol modülü"),
            ("module_final_quality_control", "Final kalite kontrol ve sevk onayı"),
        ),
    },
    {
        "title": "Yeni Modül Havuzu - İleri Kalite Araçları",
        "items": (
            ("module_apqp", "APQP proje ve kapı kontrol modülü"),
            ("module_ppap", "PPAP dosya ve müşteri sunum modülü"),
            ("module_control_plan", "Kontrol planı modülü"),
            ("module_inspection_plan", "Muayene planı ve numune alma planı"),
            ("module_process_flow_diagram", "Proses akış diyagramı modülü"),
            ("module_pfmea_dfmea", "PFMEA / DFMEA modülü"),
            ("module_msa", "MSA ölçüm sistemi analizi"),
            ("module_spc", "SPC kontrol kartları"),
            ("module_cp_cpk", "Cp / Cpk proses yeterlilik analizi"),
            ("module_root_cause_toolbox", "5 Neden, Balık Kılçığı ve Pareto kök neden araçları"),
            ("module_customer_specific_requirements", "Müşteri özel şartları takip modülü"),
            ("module_quality_cost_copq", "Kalitesizlik maliyeti / COPQ takibi"),
        ),
    },
    {
        "title": "Yeni Modül Havuzu - Bakım, Ekipman ve Enerji",
        "items": (
            ("module_preventive_maintenance_calendar", "Periyodik bakım takvimi ve bakım talimatları"),
            ("module_spare_parts_inventory", "Yedek parça stok ve minimum seviye takibi"),
            ("module_equipment_service_history", "Ekipman servis geçmişi ve teknik dosya"),
            ("module_equipment_failure_analysis", "Arıza analizleri ve duruş kök neden takibi"),
            ("module_loto_safety", "LOTO / enerjiyi kesme güvenlik kontrolü"),
            ("module_energy_consumption_tracking", "Enerji tüketimi ve tasarruf takibi"),
            ("module_utility_consumption_tracking", "Su, basınçlı hava, gaz ve yardımcı tesis takipleri"),
            ("module_predictive_maintenance_notes", "Kestirimci bakım gözlem ve titreşim notları"),
            ("module_equipment_investment_roi", "Ekipman yatırım, geri dönüş ve kapasite etkisi"),
        ),
    },
    {
        "title": "Yeni Modül Havuzu - Satın Alma, Stok, Lojistik ve Müşteri",
        "items": (
            ("module_purchase_request_approval", "Satın alma talep ve onay akışı"),
            ("module_supplier_onboarding_contracts", "Tedarikçi kabul, sözleşme ve doküman takibi"),
            ("module_supplier_ppap_submission", "Tedarikçi PPAP / numune onay takibi"),
            ("module_raw_material_certificate_tracking", "Hammadde sertifika ve uygunluk belgesi takibi"),
            ("module_inventory_quality_hold", "Stok kalite blokajı / serbest bırakma"),
            ("module_warehouse_audits", "Depo düzeni ve stok doğruluk denetimi"),
            ("module_dispatch_planning", "Sevkiyat planlama ve sevk kalite kontrolü"),
            ("module_delivery_performance", "Termin performansı ve teslimat KPI takibi"),
            ("module_customer_satisfaction_survey", "Müşteri memnuniyeti anket ve analiz modülü"),
        ),
    },
    {
        "title": "Yeni Modül Havuzu - Entegre Yönetim ve Uyum",
        "items": (
            ("module_iso14001_environmental_aspects", "ISO 14001 çevresel boyut ve etki analizi"),
            ("module_iso45001_ohs_management", "ISO 45001 İSG yönetimi"),
            ("module_emergency_drill_tracking", "Acil durum tatbikat ve ekip takip modülü"),
            ("module_legal_compliance_calendar", "Yasal uygunluk takvimi ve kanıt dosyası"),
            ("module_ppe_safety_observations", "KKD, saha gözlem ve davranışsal güvenlik kayıtları"),
            ("module_msds_sds_management", "MSDS / SDS kimyasal güvenlik bilgi formu arşivi"),
            ("module_esg_sustainability_kpis", "ESG / sürdürülebilirlik KPI takip modülü"),
            ("module_data_retention_records", "KVKK veri saklama, imha ve kayıt envanteri"),
        ),
    },
    {
...
def calibration_dashboard_context():
    ...
    suitable_count = sum(
        1
        for record in all_records
        if calibration_status_label(record) == "UYGUN"
    )
    return {
        "records": records,
